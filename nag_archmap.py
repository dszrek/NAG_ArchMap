...
class NagArchMap:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&NAG_ArchMap')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'NagArchMap')
        self.toolbar.setObjectName(u'NagArchMap')

        #print "** INITIALIZING NagArchMap"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('NagArchMap', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/nag_archmap/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'NAG_ArchMap'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD NagArchMap"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&NAG_ArchMap'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = NagArchMapDockWidget()
